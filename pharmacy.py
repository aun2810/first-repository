...
def open___window():
    ...
    form_window = camvas1.create_window(40, 170, anchor='nw', window=form_entry)
    ...
    camvas1.create_text(150, 100, text="FEEDBACK FORM ^.^", font=("Times",20,'underline'))
    camvas1.create_text(180, 130, text="tell us about your experience!", font=("Times",20))


    sub_btn =Button(pycharm, font=("Times", 16), text="Submit", width=8,fg="black",command=kiki)
...
def open__window():
    ...
    # btt = Button(root1,width=15, text="FORM", bg = "paleturquoise", fg = "navy" ,
    #              font = ("Times", 16) ,command=open___window)

    btt.place(x=600,y=630)
...
#
    ...
    style.configure("Treeview.insert", font=("Times", 15))
...
#CREATING LISTBOX
    ...
    my_list = Listbox(f1, width=100, bg="slategray1",fg="navy",font=("Times",16))
    for i in y:
...
#BUTTON FOR SELECTING AN ITEM FROM LISTBOX
    ...
    btn = Button(f1, command=select, text="SELECT", bg="lightcyan2", fg="dodgerblue4", font=("Times",16))
